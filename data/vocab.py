...
class VocabEntry(object):
    ...
    def to_input_tensor_tgt(self, sents_src, sents_tgt, device):
        (word_src_ids, word_tgt_ids, word_src_complete_ids, word_tgt_complete_ids,
...
class Vocab(object):
    ...
    def save(self, file_path):
        json.dump(dict(src_word2id=self.src.word2id, tgt_word2id=self.tgt.word2id), open(file_path, 'w'), indent=2, ensure_ascii=False)
...
if __name__ == '__main__':
    ...
    print('reading in src word: %s' % args['--train-src'])
    ...
    print('reading in tgt word: %s' % args['--train-tgt'])
